...
function pages() {
  return gulp.src(['src/pages/**/*.html', '!src/pages/archive/**/*.html', 'src/pages/**/*.php', '!src/pages/archive/**/*.php'])
    .pipe(panini({
      root: 'src/pages',
      layouts: 'src/layouts',
...
function inline() {
  return gulp.src(['dist/**/*.html', 'dist/**/*.php'])
...
function watch() {
  gulp.watch(['src/pages/**/*.html', 'src/pages/**/*.php']).on('all', gulp.series(pages, inline, browser.reload));
