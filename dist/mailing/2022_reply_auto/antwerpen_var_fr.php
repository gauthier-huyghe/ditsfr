<?php
include dirname(__FILE__).'/../../antwerpen/common.php';

$text01 = 'Bonjour,';
$text02 = 'Nous avons le plaisir de vous informer que nous avons bien reçu votre pré-inscription à DINNER IN THE SKY.<br/>
Vous serez informé du prix et de l\'ouverture des réservations en priorité durant le mois de mai 2022.<br/>
Nous nous réjouissons de vous accueillir très prochainement dans le ciel anversois.<br>';
...
$cta_url = 'https://dinnerinthesky.be/antwerpen/book/reservation-2022.php';
...
$viewweb_url = 'http://www.dinnerinthesky.be/mailing/2022_reply_auto/antwerpen_fr.php';
...
$openText02 = 'Nous nous réjouissons de vous accueillir très prochainement dans le ciel anversois,<br/><br/>L\'Equipe Dinner in the Sky<br/>';

$openImage01 = 'https://dinnerinthesky.be/mailing/2022_reply_auto/img/Antwerp_dits_2019_1.jpg';

$openViewweb_url = 'http://www.dinnerinthesky.be/mailing/2022_reply_auto/antwerpen_open_fr.php';
?>