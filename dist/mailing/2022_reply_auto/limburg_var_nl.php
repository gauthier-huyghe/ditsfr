<?php
include dirname(__FILE__).'/../../limburg/common.php';
include dirname(__FILE__).'/../../limburg/translate.nl.php';

$text01 = 'Beste,';
$text02 = 'Wij hebben uw voorinschrijving voor DINNER IN THE SKY goed ontvangen en danken u hiervoor.<br/>
Zult U als eerste op de hoogte gebracht worden van de prijs en de opening van de definitieve inschrijvingen.<br/>
...
$openViewweb_url = 'http://www.dinnerinthesky.be/mailing/2022_reply_auto/limburg_open_nl.php';
?>