...
include dirname(__FILE__).'/../../limburg/translate.en.php';

$text01 = 'Dear,';
$text02 = 'We are pleased to inform you that we have received your pre-registration form for a DINNER IN THE SKY.<br/>
You will be sent in priority the information on the price and the opening of registrations.<br/>
...
$openViewweb_url = 'http://www.dinnerinthesky.be/mailing/2022_reply_auto/limburg_open_en.php';
?>