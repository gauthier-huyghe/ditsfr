<template>
  ...
  >
    ...
    <nav class="header-light__left">
      <TheLogo />
      <!-- <div class="header-light__left-menu">
        <p class="header-light__title" v-html="$t('header_title')" />
      </div> -->
    </nav>

    <!-- RIGHT : PAGES + SEARCH + EXTERNAL LINK -->
    <nav class="header-light__right">
      <!-- <div class="header-light__right-wrapper">
        <UiSlideUpDown :active="isTop">
          <div class="header-light__right-menu">
