...
include dirname(__FILE__).'/../../limburg/translate.fr.php';

$text01 = 'Bonjour,';
$text02 = 'Nous avons le plaisir de vous informer que nous avons bien reçu votre pré-inscription à DINNER IN THE SKY.<br/>
Vous serez informé du prix et de l\'ouverture des réservations en priorité.<br/>
...
$openViewweb_url = 'http://www.dinnerinthesky.be/mailing/2022_reply_auto/limburg_open_fr.php';
