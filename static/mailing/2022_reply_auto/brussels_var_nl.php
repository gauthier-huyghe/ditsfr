...
$copyright = 'Copyright © 2023 Dinner in the sky, Alle rechten voorbehouden.';
...
$openText01 = 'Geachte heer, mevrouw,<br/><br/>Dank u voor uw interesse in Dinner in the Sky.<br/>Het verheugt ons u te kunnen meedelen dat u nu in onze databank bent opgenomen.<br/>U wordt bij voorrang op de hoogte gehouden van alle informatie over onze volgende evenementen.<br/>Reserveringen voor ons evenement in mei 2024 zijn momenteel open via de volgende link: ';
...
$openViewweb_url = 'http://www.dinnerinthesky.be/mailing/2022_reply_auto/index_open_nl.php';
?>