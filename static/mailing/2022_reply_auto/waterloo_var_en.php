...
$copyright = 'Copyright © 2022 Dinner in the sky, All right reserved.';
$legal_url = 'https://dinnerinthesky.be/en/legal';
$legal_text = 'Privacy policy &amp; Cookies Policy';

$viewweb_url = 'http://www.dinnerinthesky.be/mailing/2022_reply_auto/waterloo_en.php';
...
$openText01 = 'Dear Sir or Madam,<br/><br/>Thank you for your interest in Dinner in the Sky.<br/>We are pleased to inform you that you are now registered in our data base.<br/>You will be informed in priority if any places become available as well as all information concerning our next events.<br/>Please note that reservations for our June 2023 event are currently open via the following link:';
...
$openViewweb_url = 'https://dinnerinthesky.be/mailing/2022_reply_auto/waterloo_open_en.php';
?>